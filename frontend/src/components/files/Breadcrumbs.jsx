...
export default function Breadcrumbs({ currentPath, onNavigate }) {
  ...
  return (
    <nav className="flex items-center gap-1 text-sm text-slate-500 dark:text-slate-400 py-2 px-4 bg-white dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-700/50">
      <button
